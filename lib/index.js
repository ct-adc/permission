(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["ct-adc-permission"] = factory(require("ct-utility"), require("vue"));
	else
		root["ct-adc-permission"] = factory(root["ct-utility"], root["vue"]);
})(typeof self !== 'undefined' ? self : this, function(__WEBPACK_EXTERNAL_MODULE_73__, __WEBPACK_EXTERNAL_MODULE_74__) {
...
var permission = {
    _option: {
        ...
        ajax: {
            url: '',
            type: 'get',
            data: function data(pageId) {
                return {
                    pageId: pageId
                };
            }
        },
        resFilter: function resFilter(res) {
            res = __WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.objTransfer.lowerKey(res);
            if (res.code === 0) {
                return {
                    status: true,
                    msg: '',
    ...
    _registerComponent: function _registerComponent() {
        __WEBPACK_IMPORTED_MODULE_3_vue___default.a.component('no-permission', {
    ...
    initRouterHook: function initRouterHook(router) {
            ...
            if (requireAuth) {
                ...
                var hasPermission = to.matched.every(function (record) {
                    if (record.meta.requireAuth && typeof record.meta.authCode !== 'undefined') {
                        return __WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.getObjValByKey(_permission, record.meta.authCode);
                    } else if (record.meta.requiredAuth) {
                        return _permission.page;
                    }
                    return true;
                });
                ...
                if (!hasPermission) {
                    next({
                        path: '/no-permission',
                        query: {
                            note: new __WEBPACK_IMPORTED_MODULE_3_vue___default.a().permissionNote
                        }
                    });
                } else {
                    next();
    ...
    getPermission: function getPermission(page) {
        var _this = this;

        var pageId = this._option.config[page].pageId;
        var ajaxConfig = JSON.parse(__WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(this._option.ajax));

        ajaxConfig.data = this._option.ajax.data(pageId);
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.resolve($.ajax(ajaxConfig)).then(function (res) {
            res = _this._option.resFilter(res);
            if (res.status) {
