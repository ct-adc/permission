...
var permission = {
    ...
    initRouterHook: function initRouterHook(router, page) {
        var _this = this;
        ...
        router.beforeEach(function (to, from, next) {
            ...
            if (requireAuth) {
                _this.getPermission(page).then(function (_ref) {
                    ...
                    var hasPermission = to.matched.every(function (record) {
                        if (record.meta.requireAuth && typeof record.meta.authCode !== 'undefined') {
                            return __WEBPACK_IMPORTED_MODULE_2_ct_utility___default.a.base.getObjValByKey(permission, record.meta.authCode);
    ...
    getPermission: function getPermission(page) {
        ...
        return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.resolve($.ajax(ajaxConfig)).then(function (res) {
            res = _this2._option.resFilter(res);
            if (res.status) {
                var _permission = _this2._parser(page, res.data);

                _this2._mix(_permission);

                return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.resolve({
                    permission: _permission,
                    note: _this2._option.noPermission
                });
            }

            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.reject(res.msg);
        }).catch(function (msg) {
            var permission = _this2._parser(page);

            _this2._mix(permission);

            return __WEBPACK_IMPORTED_MODULE_0_babel_runtime_core_js_promise___default.a.resolve({
                permission: permission,
                note: _this2._option.reqErrorFree ? _this2._option.noPermission : msg
            });
        });
    }
};
