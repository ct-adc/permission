...
var permission = {
    ...
    _parser: function _parser(page) {
        ...
        var pagePermissionStr = __WEBPACK_IMPORTED_MODULE_1_babel_runtime_core_js_json_stringify___default()(pageConfig).replace(/pageId:\d+/g, '').replace(/\d{5,10}/g, function (match) {
            match = match * 1;
